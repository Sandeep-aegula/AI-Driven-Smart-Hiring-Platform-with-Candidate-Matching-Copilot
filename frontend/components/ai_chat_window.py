"""components/ai_chat_window.py - HirePilot AI Chat Window.
...
from frontend.components.ai_message import render_message
from frontend.components.ai_typing_indicator import render_typing_indicator
